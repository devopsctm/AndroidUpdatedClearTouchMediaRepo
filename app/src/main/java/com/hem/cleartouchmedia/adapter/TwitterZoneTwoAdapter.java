...
public class TwitterZoneTwoAdapter extends SliderViewAdapter<TwitterZoneTwoAdapter.TwitterZoneTwoAdapterViewHolder> {

    Context mContext;
    JSONArray jsonTwitterListResponse;

    // Constructor
    public TwitterZoneTwoAdapter(Context context, JSONArray jsonTwitterListResponse) {
    ...
    @Override
    public TwitterZoneTwoAdapterViewHolder onCreateViewHolder(ViewGroup parent) {
        View inflate = LayoutInflater.from(parent.getContext()).inflate(R.layout.adapter_twitter_item, null);
        return new TwitterZoneTwoAdapterViewHolder(inflate);
    }

    // Inside on bind view holder we will
    // set data to item of Slider View.
    @Override
    public void onBindViewHolder(TwitterZoneTwoAdapterViewHolder viewHolder, final int position) {
...
//                                                          itemList.add(respVideoData.getString("url"));
    ...
    static class TwitterZoneTwoAdapterViewHolder extends ViewHolder {
        ...
        public TwitterZoneTwoAdapterViewHolder(View itemView) {
            super(itemView);
