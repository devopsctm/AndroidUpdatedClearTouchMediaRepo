...
public class YoutubeZoneFourAdapter extends SliderViewAdapter<YoutubeZoneFourAdapter.YoutubeAdapterViewHolder> {
    ...
    // Constructor
    public YoutubeZoneFourAdapter(Context context, JSONArray jsonYoutubeListResponse) {
        this.mContext = context;
        this.jsonYoutubeListResponse = jsonYoutubeListResponse;
    }

    public YoutubeZoneFourAdapter(Context context, String[] youtubeVideoID) {
        this.mContext = context;
