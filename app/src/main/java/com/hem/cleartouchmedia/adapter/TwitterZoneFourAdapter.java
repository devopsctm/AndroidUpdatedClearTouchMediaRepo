...
public class TwitterZoneFourAdapter extends SliderViewAdapter<TwitterZoneFourAdapter.TwitterAdapterViewHolder> {

    Context mContext;
    JSONArray jsonTwitterListResponse;

    // Constructor
    public TwitterZoneFourAdapter(Context context, JSONArray jsonTwitterListResponse) {
