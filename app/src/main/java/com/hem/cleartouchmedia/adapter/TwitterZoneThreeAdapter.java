...
public class TwitterZoneThreeAdapter extends SliderViewAdapter<TwitterZoneThreeAdapter.TwitterAdapterViewHolder> {

    Context mContext;
    JSONArray jsonTwitterListResponse;

    // Constructor
    public TwitterZoneThreeAdapter(Context context, JSONArray jsonTwitterListResponse) {
