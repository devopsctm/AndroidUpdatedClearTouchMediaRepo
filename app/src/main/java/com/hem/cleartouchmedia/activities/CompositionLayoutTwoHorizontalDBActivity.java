...
import com.hem.cleartouchmedia.listener.LayoutTwoHorizontalPlayerListener;
...
public class CompositionLayoutTwoHorizontalDBActivity extends AppCompatActivity
        implements IVLCVout.Callback {

    public String TAG = CompositionLayoutTwoHorizontalDBActivity.class.getSimpleName();
    ...
    private MediaPlayer.EventListener mPlayerListenerZoneOne = new LayoutTwoHorizontalPlayerListener(this);
    ...
    private MediaPlayer.EventListener mPlayerListenerZoneTwo = new LayoutTwoHorizontalPlayerListener(this);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(SCREEN_TYPE.equalsIgnoreCase("PORTRAIT"))
        {
            ...
            setContentView(R.layout.activity_composition_zone_two_horizontal);
        }
        else
        {
...
//                    delayZoneThree = Integer.valueOf(mZoneThreeDurationList.get(countZoneThree))*1000;
                ...
                {
//                    System.out.println("===== res zone three else condition");
                    countZoneThree = 0;
                    countThree = 0;
        ...
        if(compositionLayoutDetail.getType().equalsIgnoreCase("image"))
        {
            if(mIsBGMedia.equalsIgnoreCase("1"))
            {
                if (isMyServiceRunning(MusicService.class)) {
                    ...
                    startService(new Intent(CompositionLayoutTwoHorizontalDBActivity.this, MusicService.class));
                }
            }
            ...
            new Thread(() -> {
                Glide.get(CompositionLayoutTwoHorizontalDBActivity.this).clearDiskCache();
            }).start();
            Glide.get(CompositionLayoutTwoHorizontalDBActivity.this).clearMemory();
...
//                    Uri uri = Uri.parse(Environment.getExternalStorageDirectory()+"/Pictures/"+imageArray[1]);
                    ...
                    Glide.with(getApplicationContext())
                            ...
                            .listener(new RequestListener<Drawable>() {
                                ...
                                public boolean onLoadFailed(GlideException e, Object model, Target<Drawable> target, boolean isFirstResource) {
                                    Log.e("GlideError", "Load failed", e);
                                    Glide.get(CompositionLayoutTwoHorizontalDBActivity.this).clearDiskCache(); // Call this in a background thread
                                    Glide.get(CompositionLayoutTwoHorizontalDBActivity.this).clearMemory();
...
//                                    tv_zone.setText(mJsonObject.getString("timezone"));
        ...
        else if(compositionLayoutDetail.getType().equalsIgnoreCase("video"))
        {
            if(mIsBGMedia.equalsIgnoreCase("1"))
            {
                if (isMyServiceRunning(MusicService.class)) {
                    System.out.println("<<<<<<<<<<< media is on stop() sevice start: ");
                    stopService(new Intent(CompositionLayoutTwoHorizontalDBActivity.this, MusicService.class));
                }
            }
            if(mMediaPlayerZoneOne != null)
            {
            ...
            if(compositionLayoutDetail.getUrl() != null)
            {
                ...
                if(imgFile.exists()){
                    ...
                    videoViewZoneOne.setOnErrorListener((mp, what, extra) -> {
                        Toast.makeText(CompositionLayoutTwoHorizontalDBActivity.this, "Download result error\n Downloading again.. ", Toast.LENGTH_LONG).show();
                        if (info != null && info.isConnected())
                        {
...
//            txtMarquee.setSpeed(100.0f);
        ...
        else if(compositionLayoutDetail.getType().equalsIgnoreCase("rtsp"))
        {
            ...
            if(compositionLayoutDetail.getApp_url() != null)
            {
                ...
                mSurfaceZoneTwo = findViewById(R.id.zone_three_rtsp);
                WindowManager wm = this.getWindowManager();
                int width = wm.getDefaultDisplay().getWidth();
                int height = wm.getDefaultDisplay().getHeight();
                int iNewWidth = (int) (height * 3.0 / 4.0);
...
//                mSurfaceZoneTwo.getHolder().addCallback(new SurceCallBack());
    ...
    private void getYoutubeAPIZoneOneResponse(String youtubeVideo, int slide_duration) throws JSONException  {
        JSONObject jsonYoutubeDataResponse = new JSONObject(youtubeVideo);
        Log.d("TAG", "<< Response of json youtube local youtubeVideo>>>>> "
                +jsonYoutubeDataResponse);

        JSONArray jsonYoutubeListResponse = new JSONArray(jsonYoutubeDataResponse.getString("items"));
        if(jsonYoutubeListResponse != null)
        {
            YoutubeZoneOneAdapter adapter = new YoutubeZoneOneAdapter(CompositionLayoutTwoHorizontalDBActivity.this,
                    jsonYoutubeListResponse);
    ...
    private void getTwitterAPILocalResponse(String  twitterProfileData,
        ...
        for(int i = 0; i < twitterArryaData.length(); i++) {
            ...
            if(zone == 1)
            {
                ...
                tvName.setText(respTwitterObj.getString("name"));
                tvUserName.setText(respTwitterObj.getString("username"));
                /*Picasso.get().
...
//            Log.d("TAG", "<< Response of twitterDetail "+twitterResponse.getMediaData().getSlideDuration());
            ...
            TwitterZoneOneAdapter adapter = new TwitterZoneOneAdapter(CompositionLayoutTwoHorizontalDBActivity.this,
...
//                    sliderView_zone_two.setScrollTimeInSec(mSlideDuration);
    ...
    public void updateCompositionLayoutDetail() {
        ...
        compositionLayoutDetailViewModel.getCompositionLayoutDetail().observe(this, new Observer<List<CompositionLayoutDetail>>() {
            ...
            public void onChanged(List<CompositionLayoutDetail> compositionLayoutDetail) {
                ...
                handleCompositionLayoutDetails(compositionLayoutDetail);
                handleBackgroundMedia(compositionLayoutDetail);
                handleZoneOne(compositionLayoutDetail);
                handleZoneThree(compositionLayoutDetail);

                if(mZoneOneList.size()>0 || mZoneThreeList.size()>0)
                {
                    if(mFlag == 0)
                    {
                                ...
                                if (layoutDetailList.size() > 0) {
                                    for (int i = 0; i < layoutDetailList.size(); i++) {
                                        ...
                                        if (compositionLayoutDetail != null) {
                                            ...
                                            Log.d(TAG, "<< Response layout two : "+compositionLayoutDetail);
                                            if(compositionLayoutDetail.getBGMusicUrl() != null)
                                            {
                                                ...
                                                ApplicationPreferences.getInstance(CompositionLayoutTwoHorizontalDBActivity.this)
...
//                                    updateCompositionLayoutDetail();
    ...
    protected void onStart() {
        ...
        Log.d(TAG, "<< onStart method in layout 2 Horizontal ");
        compositionLayoutDetailViewModel = new ViewModelProvider(this).get(CompositionLayoutDetailViewModel.class);
        ...
        handlerLoginStatus.postDelayed(runnableLoginStatus = new Runnable() {
            public void run() {
                ...
                ConnectivityManager manager = (ConnectivityManager) CompositionLayoutTwoHorizontalDBActivity.this.getSystemService(CONNECTIVITY_SERVICE);
                NetworkInfo info = manager != null ? manager.getActiveNetworkInfo() : null;
                if (info != null && info.isConnected())
                {
                    RetrofitAPIInerface apiService = RetrofitClient.getClient().create(RetrofitAPIInerface.class);
                        ...
                        public void onResponse(Call<DevicePushStatusReponse> call, Response<DevicePushStatusReponse> response) {
                            if(response.isSuccessful()) {
                                ...
                                if(devicePushStatusReponse.getStatus().equalsIgnoreCase("1"))
                                {
                                    ...
                                    {
                                        Log.d(TAG, "<< Response of devicePushData success layout 2 h"+devicePushData.getPushStatus());
...
//                Toast.makeText(CompositionLayoutTwoHorizontalDBActivity.this, "This method is run every 10 seconds",
                ...
                if(compositionLayoutDetail != null)
                {
                    for(int i = 0; i< compositionLayoutDetail.size(); i++)
                    {
                        ...
                        else if(compositionLayoutDetail.get(i).getZone_type().equalsIgnoreCase("zone2"))
                        {
                            ...
                            {
                                compositionLayoutDetailsThree.add(layoutDetail2);
...
//                        updateCompositionLayoutDetail();
    ...
    private void deviceStatus(String status, String method) {
        Log.d(TAG, "<< device status is: "+status +" << device method is: "+method+" << device layout is 2h");
    ...
    public void deleteCache(Context context) {
        try {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN) {
                finishAffinity();
                startActivity(new Intent(CompositionLayoutTwoHorizontalDBActivity.this,
                        SplashActivity.class));
            } else {
                ActivityCompat.finishAffinity(CompositionLayoutTwoHorizontalDBActivity.this);
                startActivity(new Intent(CompositionLayoutTwoHorizontalDBActivity.this,
                        SplashActivity.class));
            }
    ...
    {
        Log.d(TAG, "<< push status in layout 2 horizontal:  " + ApplicationPreferences.getInstance(getApplicationContext()).getNotificationReceive());
        Log.d(TAG, "<< push status in layout 2 horizontal COMPOSITION_ID:  " + getIntent().getStringExtra("COMPOSITION_ID"));
        Log.d(TAG, "<< push status in layout 2 horizontal ORIENTATION:  " + getIntent().getStringExtra("ORIENTATION"));
    ...
    protected void onResume() {
        /*if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.R)
        {
            ...
            if(!Utils.isPermissionGranted(CompositionLayoutTwoHorizontalDBActivity.this))
            {
                new AlertDialog.Builder(CompositionLayoutTwoHorizontalDBActivity.this)
            ...
            {
//            Toast.makeText(CompositionLayoutTwoHorizontalDBActivity.this, "Permission already granted", Toast.LENGTH_LONG).show();
            }
        }*/
                        ...
                        public void onResponse(Call<DevicePushStatusReponse> call, Response<DevicePushStatusReponse> response) {
                            if(response.isSuccessful()) {
                                ...
                                if(devicePushStatusReponse.getStatus().equalsIgnoreCase("1"))
                                {
                                    ...
                                    if(devicePushData != null)
                                    {
                                        Log.d(TAG, "<< Response of devicePushData success layout 2h"+devicePushData.getPushStatus());
                                        if(devicePushData.getPushStatus().equalsIgnoreCase("1"))
                                        {
                                            setDeleteDatabase();
                                        }
...
//                Toast.makeText(context, "Download result error: " + result, Toast.LENGTH_LONG).show();
                ...
                ApplicationPreferences.getInstance(CompositionLayoutTwoHorizontalDBActivity.this).setIsDownload(true);
...
//                Toast.makeText(CompositionLayoutThreeDBActivity.this, "Video Download complete.", Toast.LENGTH_SHORT).show();
    ...
    public void newDownload(String url, String type) {
        final DownloadTask downloadTask = new DownloadTask(CompositionLayoutTwoHorizontalDBActivity.this);
...
//            Toast.makeText(this, "Image deletion failed", Toast.LENGTH_SHORT).show();
    ...
    private void takePermission()
    {
        ...
        {
            /*ActivityCompat.requestPermissions(CompositionLayoutTwoHorizontalDBActivity.this, new String[] {
