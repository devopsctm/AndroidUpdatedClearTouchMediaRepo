...
import com.hem.cleartouchmedia.listener.LayoutTwoZoneOnePlayerListener;
import com.hem.cleartouchmedia.listener.LayoutTwoZoneTwoPlayerListener;
...
public class CompositionLayoutTwoDBActivity extends AppCompatActivity
        implements IVLCVout.Callback {
    private static final String TAG = CompositionLayoutTwoDBActivity.class.getSimpleName();
    ...
    private MediaPlayer.EventListener mPlayerListenerZoneOne = new LayoutTwoZoneOnePlayerListener(this);
    ...
    private MediaPlayer.EventListener mPlayerListenerZoneTwo = new LayoutTwoZoneTwoPlayerListener(this);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(SCREEN_TYPE.equalsIgnoreCase("PORTRAIT"))
        {
            ...
            setContentView(R.layout.activity_composition_zone_two_portrait);
        }
        else
        {
            setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_LANDSCAPE);
            setContentView(R.layout.activity_composition_zone_two);
        }
        ...
        if(compositionLayoutDetail.getType().equalsIgnoreCase("image"))
        {
            if(mIsBGMedia.equalsIgnoreCase("1"))
            {
                if (isMyServiceRunning(MusicService.class)) {
                    ...
                    startService(new Intent(CompositionLayoutTwoDBActivity.this, MusicService.class));
                }
            }
            ...
            new Thread(() -> {
                Glide.get(CompositionLayoutTwoDBActivity.this).clearDiskCache();
            }).start();
            Glide.get(CompositionLayoutTwoDBActivity.this).clearMemory();
...
//                            .error(R.drawable.error_image)
                            .listener(new RequestListener<Drawable>() {
                                ...
                                public boolean onLoadFailed(GlideException e, Object model, Target<Drawable> target, boolean isFirstResource) {
                                    ...
                                    Glide.get(CompositionLayoutTwoDBActivity.this).clearDiskCache(); // Call this in a background thread
                                    Glide.get(CompositionLayoutTwoDBActivity.this).clearMemory();
                                    return false;
                                }
...
//                    videoViewZoneOne.setVideoURI(uri);
            ...
            System.out.println("<<<<<<<<<<< media is image ");
...
//                SimpleDateFormat tf = new SimpleDateFormat("HH:mm a");
        ...
        else if(compositionLayoutDetail.getType().equalsIgnoreCase("video"))
        {
            if(mIsBGMedia.equalsIgnoreCase("1"))
            {
                if (isMyServiceRunning(MusicService.class)) {
                    System.out.println("<<<<<<<<<<< media is on stop() sevice start: ");
                    stopService(new Intent(CompositionLayoutTwoDBActivity.this, MusicService.class));
                }
            }
            if(mMediaPlayerZoneOne != null)
            {
            ...
            if(compositionLayoutDetail.getUrl() != null)
            {
                ...
                if(imgFile.exists()){
                    ...
                    videoViewZoneOne.setOnErrorListener((mp, what, extra) -> {
                        Toast.makeText(CompositionLayoutTwoDBActivity.this, "Download result error\n Downloading again.. ", Toast.LENGTH_LONG).show();
                        if (info != null && info.isConnected())
                        {
...
//                    Uri uri = Uri.parse(Constant.imgURL+compositionLayoutDetail.getUrl());
        ...
        else if(compositionLayoutDetail.getType().equalsIgnoreCase("text_app"))
        {
            ...
            /*LinearLayout ll_zone_one = findViewById(R.id.layout_one);
            ...
            ll_zone_one.setLayoutParams(childParam3);
...
//            txtMarquee.setSpeed(100.0f);
        ...
        else if(compositionLayoutDetail.getType().equalsIgnoreCase("youtube"))
        {
            ...
            Log.d("zone three area", "<<<<< youtube video");
            mZoneThreeLayoutImg.setVisibility(View.GONE);
            mZoneThreeLayoutWeather.setVisibility(View.GONE);
            mZoneThreeLayoutDigitalClock.setVisibility(View.GONE);
            mZoneThreeLayoutTwitter.setVisibility(View.GONE);
...
//                mSurfaceZoneTwo.getHolder().addCallback(new SurceCallBack());
    ...
    private void getYoutubeAPIZoneOneResponse(String[] youtubeVideoID, int slide_duration) throws JSONException {
        ...
        {
            YoutubeZoneOneAdapter adapter = new YoutubeZoneOneAdapter(CompositionLayoutTwoDBActivity.this,
                    youtubeVideoID);
    ...
    private void getYoutubeAPIZoneThreeResponse(String[] youtubeVideo, int slide_duration) throws JSONException  {
        ...
        {
            YoutubeZoneThreeAdapter adapter = new YoutubeZoneThreeAdapter(CompositionLayoutTwoDBActivity.this,
                    youtubeVideo);
...
//            Log.d("TAG", "<< Response of twitterDetail "+twitterResponse.getMediaData().getSlideDuration());
                ...
                TwitterZoneOneAdapter adapter = new TwitterZoneOneAdapter(CompositionLayoutTwoDBActivity.this,
...
//            Log.d("TAG", "<< Response of twitterDetail "+twitterResponse.getMediaData().getSlideDuration());
                // passing this array list inside our adapter class.
                TwitterZoneThreeAdapter adapter =
                        new TwitterZoneThreeAdapter(CompositionLayoutTwoDBActivity.this,
                        jsonTwitterListResponse);
                // below method is used to set auto cycle direction in left to
                // right direction you can change according to requirement.
                ...
                else if (zone == 3)
                {
                    ...
                    else if(mJsonObject2.getString("main").equalsIgnoreCase("Fog"))
                    {
                        Glide.with(getApplicationContext())
                                ...
                                .diskCacheStrategy(DiskCacheStrategy.ALL)
                                .into(weather_icon_two_zone_three);
//                        icon_weather_zone_one.setBackgroundResource(R.drawable.foggy);
                    }
                    else if(mJsonObject2.getString("main").equalsIgnoreCase("Clear"))
                    {
                        Glide.with(getApplicationContext())
                                    ...
                                    for (int i = 0; i < layoutDetailList.size(); i++) {
                                        ...
                                        if (compositionLayoutDetail != null) {
                                            ...
                                            if(compositionLayoutDetail.getBGMusicUrl() != null)
                                            {
                                                ...
                                                ApplicationPreferences.getInstance(CompositionLayoutTwoDBActivity.this)
...
//                                    updateCompositionLayoutDetail();
    ...
    protected void onStart() {
        ...
        Log.d(TAG, "<< onStart method in layout 2  ");
        compositionLayoutDetailViewModel = new ViewModelProvider(this).get(CompositionLayoutDetailViewModel.class);
        ...
        handlerLoginStatus.postDelayed(runnableLoginStatus = new Runnable() {
            public void run() {
                ...
                ConnectivityManager manager = (ConnectivityManager) CompositionLayoutTwoDBActivity.this.getSystemService(CONNECTIVITY_SERVICE);
                NetworkInfo info = manager != null ? manager.getActiveNetworkInfo() : null;
                if (info != null && info.isConnected())
                {
                    RetrofitAPIInerface apiService = RetrofitClient.getClient().create(RetrofitAPIInerface.class);
                        ...
                        public void onResponse(Call<DevicePushStatusReponse> call, Response<DevicePushStatusReponse> response) {
                            if(response.isSuccessful()) {
                                ...
                                if(devicePushStatusReponse.getStatus().equalsIgnoreCase("1"))
                                {
                                    ...
                                    {
                                        Log.d(TAG, "<< Response of devicePushData success layout 2"+devicePushData.getPushStatus());
    ...
    private void deviceStatus(String status, String method) {
        Log.d(TAG, "<< device status is: "+status +" << device method is: "+method+" << device layout is 2");
    ...
    public void deleteCache(Context context) {
        try {
            ...
            deleteDir(dir);
            startActivity(new Intent(CompositionLayoutTwoDBActivity.this, SplashActivity.class));
    ...
    {
        Log.d(TAG, "<< push status in layout 2:  " + ApplicationPreferences.getInstance(getApplicationContext()).getNotificationReceive());
        Log.d(TAG, "<< push status in layout 2 COMPOSITION_ID:  " + getIntent().getStringExtra("COMPOSITION_ID"));
        Log.d(TAG, "<< push status in layout 2 ORIENTATION:  " + getIntent().getStringExtra("ORIENTATION"));
    ...
    protected void onResume() {
        /*if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.R)
        {
            ...
            if(!Utils.isPermissionGranted(CompositionLayoutTwoDBActivity.this))
            {
                new AlertDialog.Builder(CompositionLayoutTwoDBActivity.this)
            ...
            {
//            Toast.makeText(CompositionLayoutTwoDBActivity.this, "Permission already granted", Toast.LENGTH_LONG).show();
            }
        }*/
...
//                Toast.makeText(context, "Download result error: " + result, Toast.LENGTH_LONG).show();
                ...
                ApplicationPreferences.getInstance(CompositionLayoutTwoDBActivity.this).setIsDownload(true);
...
//                Toast.makeText(CompositionLayoutThreeDBActivity.this, "Video Download complete.", Toast.LENGTH_SHORT).show();
    ...
    public void newDownload(String url, String type) {
        final DownloadTask downloadTask = new DownloadTask(CompositionLayoutTwoDBActivity.this);
...
//            Toast.makeText(this, "Image deletion failed", Toast.LENGTH_SHORT).show();
    ...
    private void takePermission()
    {
        ...
        {
            /*ActivityCompat.requestPermissions(CompositionLayoutTwoDBActivity.this, new String[] {
                    Manifest.permission.READ_EXTERNAL_STORAGE, Manifest.permission.WRITE_EXTERNAL_STORAGE
            }, 101);*/
        }
    }

    // Define RequestOptions with downsampling to scale the image to fit within the target size
    RequestOptions requestOptions = new RequestOptions()
            .diskCacheStrategy(DiskCacheStrategy.ALL) // Cache the original and downscaled images
