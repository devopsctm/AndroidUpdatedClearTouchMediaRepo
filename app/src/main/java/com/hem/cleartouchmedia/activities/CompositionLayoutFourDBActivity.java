...
import com.hem.cleartouchmedia.adapter.TwitterZoneFourAdapter;
...
import com.hem.cleartouchmedia.adapter.YoutubeZoneFourAdapter;
...
import com.hem.cleartouchmedia.listener.LayoutFourPlayerListener;
...
public class CompositionLayoutFourDBActivity extends AppCompatActivity
        implements IVLCVout.Callback {

    public String TAG = CompositionLayoutFourDBActivity.class.getSimpleName();
    ...
    SliderView sliderView_zone_four;
    ...
    Handler handlerZoneFour = new Handler();
    Runnable runnableZoneFour;
    int delayZoneFour = 0;
    int countZoneFour = 0;
    int countFour = 0;
    int delayCountZoneFour = 0;
    ...
    private MediaPlayer.EventListener mPlayerListenerZoneOne = new LayoutFourPlayerListener(this);
    ...
    private MediaPlayer.EventListener mPlayerListenerZoneTwo = new LayoutFourPlayerListener(this);
    ...
    private MediaPlayer.EventListener mPlayerListenerZoneThree = new LayoutFourPlayerListener(this);

    // display surface
    private SurfaceView mSurfaceZoneFour;
    private SurfaceHolder holderZoneFour;
    // media player
    private LibVLC libvlcZoneFour;
    private MediaPlayer mMediaPlayerZoneFour = null;
    private MediaPlayer.EventListener mPlayerListenerZoneFour = new LayoutFourPlayerListener(this);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(SCREEN_TYPE.equalsIgnoreCase("PORTRAIT"))
        {
            ...
            setContentView(R.layout.activity_composition_zone_four_portrait);
        }
        else
        {
            setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_LANDSCAPE);
            setContentView(R.layout.activity_composition_zone_four);
        }
        ...
        mVideoSliderViewZoneFour = findViewById(R.id.youtube_slider_zone_four);
        ...
        sliderView_zone_four = findViewById(R.id.slider_zone_four);
        ...
        mZoneFourLayoutImg = findViewById(R.id.zone_four_layout_img);
        ...
        mZoneFourLayoutDigitalClock = findViewById(R.id.zone_four_layout_digital_clock);
        ...
        mZoneFourLayoutWeather = findViewById(R.id.zone_four_layout_weather);
        ...
        mZoneFourLayoutTwitter = findViewById(R.id.zone_four_layout_twitter);
        ...
        mZoneFourLayoutVideo = findViewById(R.id.zone_four_layout_video);
        ...
        mZoneFourLayoutURL = findViewById(R.id.zone_four_layout_url);
        ...
        mZoneFourLayoutText = findViewById(R.id.zone_four_layout_text);
        ...
        mZoneFourLayoutYoutubeVideo = findViewById(R.id.zone_four_layout_youtube_video);
        ...
        mZoneFourLayoutSpreadSheet = findViewById(R.id.zone_four_layout_spreadsheets_url);
        ...
        mZoneFourLayoutGoogleSlide = findViewById(R.id.zone_four_layout_google_slides);
        ...
        mZoneFourLayoutRTSP = findViewById(R.id.zone_four_layout_rtsp);
    }
    ...
    protected void onStart() {
        ...
        Log.d(TAG, "<< onStart method in layout 4  ");
        ...
        handlerLoginStatus.postDelayed(runnableLoginStatus = new Runnable() {
            public void run() {
                ...
                ConnectivityManager manager = (ConnectivityManager) CompositionLayoutFourDBActivity.this.getSystemService(CONNECTIVITY_SERVICE);
                        ...
                        public void onResponse(Call<DevicePushStatusReponse> call, Response<DevicePushStatusReponse> response) {
                            if(response.isSuccessful()) {
                                ...
                                if(devicePushStatusReponse.getStatus().equalsIgnoreCase("1"))
                                {
                                    ...
                                    {
                                        Log.d(TAG, "<< Response of devicePushData success layout 4: "+devicePushData.getPushStatus());
        ...
        compositionLayoutDetailsFour = new ArrayList<>();
                ...
                if(compositionLayoutDetail != null)
                {
                    for(int i = 0; i< compositionLayoutDetail.size(); i++)
                    {
                        if(compositionLayoutDetail.get(0).getBGMusicUrl() != null)
                        {
                            ...
                            ApplicationPreferences.getInstance(CompositionLayoutFourDBActivity.this)
                        ...
                        else if(compositionLayoutDetail.get(i).getZone_type().equalsIgnoreCase("zone4"))
                        {
                            CompositionLayoutDetail layoutDetail4 = compositionLayoutDetail.get(i);
                            if(layoutDetail4 != null)
                            {
                                compositionLayoutDetailsFour.add(layoutDetail4);
                                mZoneFourList.add(compositionLayoutDetail.get(i).getMedia_id());
                                mZoneFourDurationList.add(compositionLayoutDetail.get(i).getDuration());
                            }
                        }
                    }

                    if(mZoneOneList.size()>0 || mZoneTwoList.size()>0 || mZoneThreeList.size()>0 || mZoneFourList.size()>0)
                    {
                        if(mFlag == 0)
                        {
...
//                    System.out.println("===== res zone one else condition");
    ...
    private void zoneFourHandler() {
        /****      Zone Four    ****/
        mFlag = 1;
        Log.d(TAG, "<< onStart method in layout 4 zone Four inside zoneFourHandler ");
        Log.d(TAG, "<< onStart method in layout 4 zone Four inside zoneFourHandler and " +
                "mZoneFourList count:  "+mZoneFourList.size());

        handlerZoneFour.postDelayed(runnableZoneFour = new Runnable() {
            @RequiresApi(api = Build.VERSION_CODES.O)
            public void run() {
                if(mZoneFourList.size()>0 && mZoneFourList.size()>countZoneFour)
                {
                    int duration = mZoneFourDurationList.get(countZoneFour) != null
                            ? Integer.valueOf(mZoneFourDurationList.get(countZoneFour)) : 0;
                    delayZoneFour = duration * 1000;
                    delayCountZoneFour = delayZoneFour;
                    handlerZoneFour.postDelayed(runnableZoneFour, delayCountZoneFour);
                    try {
                        getZoneFour(mZoneFourList.get(countZoneFour));
                    } catch (JSONException | ParseException e) {
                        e.printStackTrace();
                    }
                }
                else
                {
                    countZoneFour = 0;
                    countFour = 0;
                    delayCountZoneFour = 0;
                    if(mZoneFourList.size() > 0)
                    {
                        int duration = mZoneFourDurationList.get(countZoneFour) != null
                                ? Integer.valueOf(mZoneFourDurationList.get(countZoneFour)) : 0;
                        delayZoneFour = duration * 1000;
                        delayCountZoneFour = delayZoneFour * countFour;
                        handlerZoneFour.postDelayed(runnableZoneFour, delayCountZoneFour);
                        try {
                            getZoneFour(mZoneFourList.get(countZoneFour));
                        } catch (JSONException | ParseException e) {
    ...
    private void getZoneOne(String media_id) throws JSONException, ParseException {
        ...
        countZoneOne++;
        countOne++;
        Log.d(TAG, "<< onStart get zone one composition id : "+compositionLayoutDetail.getComposition_id());
        Log.d(TAG, "<< onStart onStart get zone one zone type : "+compositionLayoutDetail.getType());
        Log.d(TAG, "<< onStart onStart get zone one media id : "+compositionLayoutDetail.getMedia_id());
        if(compositionLayoutDetail.getType().equalsIgnoreCase("image"))
        {
            if(mIsBGMedia.equalsIgnoreCase("1"))
            {
                if (isMyServiceRunning(MusicService.class)) {
                    ...
                    startService(new Intent(CompositionLayoutFourDBActivity.this, MusicService.class));
                }
            }
            ...
            new Thread(() -> {
                Glide.get(CompositionLayoutFourDBActivity.this).clearDiskCache();
            }).start();
            Glide.get(CompositionLayoutFourDBActivity.this).clearMemory();
...
//                    Uri uri = Uri.parse(Environment.getExternalStorageDirectory()+"/Pictures/"+imageArray[1]);
                    ...
                    Glide.with(getApplicationContext())
                            ...
                            .listener(new RequestListener<Drawable>() {
                                ...
                                public boolean onLoadFailed(GlideException e, Object model, Target<Drawable> target, boolean isFirstResource) {
                                    Log.e("GlideError", "Load failed", e);
                                    Glide.get(CompositionLayoutFourDBActivity.this).clearDiskCache(); // Call this in a background thread
                                    Glide.get(CompositionLayoutFourDBActivity.this).clearMemory();
...
//                tv_zone.setText(mJsonObject.getString("timezone"));
        ...
        else if(compositionLayoutDetail.getType().equalsIgnoreCase("video"))
        {
            if(mIsBGMedia.equalsIgnoreCase("1"))
            {
                if (isMyServiceRunning(MusicService.class)) {
                    System.out.println("<<<<<<<<<<< media is on stop() sevice start: ");
                    stopService(new Intent(CompositionLayoutFourDBActivity.this, MusicService.class));
                }
            }
            ...
            VideoView videoViewZoneOne = findViewById(R.id.zone_one_video);
            ...
            if(compositionLayoutDetail.getUrl() != null)
            {
                ...
                if(imgFile.exists()){
                    ...
                    videoViewZoneOne.setOnErrorListener((mp, what, extra) -> {
                        Toast.makeText(CompositionLayoutFourDBActivity.this, "Download result error\n Downloading again.. ", Toast.LENGTH_LONG).show();
                        if (info != null && info.isConnected())
                        {
        ...
        else if(compositionLayoutDetail.getType().equalsIgnoreCase("url"))
        {
            ...
            if(compositionLayoutDetail.getApp_url() != null)
            {
                ...
                WebView webView = (WebView) findViewById(R.id.zone_one_webview);
...
//                    Uri uri = Uri.parse(Environment.getExternalStorageDirectory()+"/Pictures/"+imageArray[1]);
        ...
        else if(compositionLayoutDetail.getType().equalsIgnoreCase("video"))
        {
            ...
            VideoView videoViewZoneTwo = findViewById(R.id.zone_two_video);
...
//                    Uri uri = Uri.parse(Environment.getExternalStorageDirectory()+"/Pictures/"+imageArray[1]);
        ...
        else if(compositionLayoutDetail.getType().equalsIgnoreCase("video"))
        {
            ...
            VideoView videoViewZoneThree = findViewById(R.id.zone_three_video);
...
//            txtMarquee.setSpeed(100.0f);
    ...
    @RequiresApi(api = Build.VERSION_CODES.O)
    private void getZoneFour(String media_id) throws JSONException, ParseException {
        mLoadingLayout.setVisibility(View.GONE);
        CompositionLayoutDetail compositionLayoutDetail = compositionLayoutDetailsFour.get(countZoneFour);
        countZoneFour++;
        countFour++;
        if(compositionLayoutDetail.getType().equalsIgnoreCase("image"))
        {
            mZoneFourLayoutImg.setVisibility(View.VISIBLE);
            mZoneFourLayoutWeather.setVisibility(View.GONE);
            mZoneFourLayoutDigitalClock.setVisibility(View.GONE);
            mZoneFourLayoutTwitter.setVisibility(View.GONE);
            mZoneFourLayoutVideo.setVisibility(View.GONE);
            mZoneFourLayoutText.setVisibility(View.GONE);
            mZoneFourLayoutURL.setVisibility(View.GONE);
            mZoneFourLayoutYoutubeVideo.setVisibility(View.GONE);
            mZoneFourLayoutSpreadSheet.setVisibility(View.GONE);
            mZoneFourLayoutGoogleSlide.setVisibility(View.GONE);
            mZoneFourLayoutRTSP.setVisibility(View.GONE);

            ImageView iv = findViewById(R.id.zone_four_img);
...
//                    Uri uri = Uri.parse(Environment.getExternalStorageDirectory()+"/Pictures/"+imageArray[1]);
        ...
        if(compositionLayoutDetail.getType().equalsIgnoreCase("digital_clock"))
        {
            mZoneFourLayoutImg.setVisibility(View.GONE);
            mZoneFourLayoutWeather.setVisibility(View.GONE);
            mZoneFourLayoutDigitalClock.setVisibility(View.VISIBLE);
            mZoneFourLayoutTwitter.setVisibility(View.GONE);
            mZoneFourLayoutVideo.setVisibility(View.GONE);
            mZoneFourLayoutText.setVisibility(View.GONE);
            mZoneFourLayoutURL.setVisibility(View.GONE);
            ...
            TextView tv_date = findViewById(R.id.zone_four_txt_digital_clock_date);
            TextView tv_time = findViewById(R.id.zone_four_txt_digital_clock_time);
            TextView tv_zone = findViewById(R.id.zone_four_txt_digital_clock_zone);
...
//                                    tv_zone.setText(mJsonObject.getString("timezone"));
        ...
        {
            mZoneFourLayoutImg.setVisibility(View.GONE);
            mZoneFourLayoutWeather.setVisibility(View.VISIBLE);
            mZoneFourLayoutDigitalClock.setVisibility(View.GONE);
            mZoneFourLayoutTwitter.setVisibility(View.GONE);
            mZoneFourLayoutVideo.setVisibility(View.GONE);
            mZoneFourLayoutText.setVisibility(View.GONE);
            ...
            if(compositionLayoutDetail.getWeatherData() != null)
            {
                getWeatherDetailByCity(compositionLayoutDetail.getWeatherData(), 4);
            }
        }
        else if(compositionLayoutDetail.getType().equalsIgnoreCase("twitter"))
        {
            ...
            mZoneFourLayoutWeather.setVisibility(View.GONE);
            mZoneFourLayoutDigitalClock.setVisibility(View.GONE);
            mZoneFourLayoutTwitter.setVisibility(View.VISIBLE);
            mZoneFourLayoutVideo.setVisibility(View.GONE);
            mZoneFourLayoutText.setVisibility(View.GONE);
            mZoneFourLayoutURL.setVisibility(View.GONE);
            mZoneFourLayoutYoutubeVideo.setVisibility(View.GONE);
        ...
        else if(compositionLayoutDetail.getType().equalsIgnoreCase("video"))
        {
            ...
            mZoneFourLayoutText.setVisibility(View.GONE);
            mZoneFourLayoutURL.setVisibility(View.GONE);
            mZoneFourLayoutVideo.setVisibility(View.VISIBLE);
            mZoneFourLayoutYoutubeVideo.setVisibility(View.GONE);
            mZoneFourLayoutSpreadSheet.setVisibility(View.GONE);
            mZoneFourLayoutGoogleSlide.setVisibility(View.GONE);
            mZoneFourLayoutRTSP.setVisibility(View.GONE);

            VideoView videoViewZoneFour = findViewById(R.id.zone_four_video);
            ...
            if(compositionLayoutDetail.getUrl() != null)
            {
                ...
                if(imgFile.exists()){
                    Log.i("ExternalStorage", "<<<<<<<<<< inside composition file exists: " +videoArray[1]);
                    Uri uri = Uri.parse(Environment.getExternalStorageDirectory()+"/Movies/"+videoArray[1]);
                    videoViewZoneFour.setVideoURI(uri);
                    videoViewZoneFour.setOnErrorListener((mp, what, extra) -> {
                        Toast.makeText(CompositionLayoutFourDBActivity.this, "Download result error\n Downloading again.. ", Toast.LENGTH_LONG).show();
                        if (info != null && info.isConnected())
                        {
                            newDownload(compositionLayoutDetail.getUrl(), "VIDEO");
                ...
                videoViewZoneFour.requestFocus();
                videoViewZoneFour.start();
            }
        }
        else if(compositionLayoutDetail.getType().equalsIgnoreCase("url"))
        {
            ...
            mZoneFourLayoutTwitter.setVisibility(View.GONE);
            mZoneFourLayoutText.setVisibility(View.GONE);
            mZoneFourLayoutURL.setVisibility(View.VISIBLE);
            mZoneFourLayoutVideo.setVisibility(View.GONE);
            mZoneFourLayoutYoutubeVideo.setVisibility(View.GONE);
            mZoneFourLayoutSpreadSheet.setVisibility(View.GONE);
            mZoneFourLayoutGoogleSlide.setVisibility(View.GONE);
            ...
            if(compositionLayoutDetail.getApp_url() != null)
            {
                ...
                WebView webView = (WebView) findViewById(R.id.zone_four_webview);
                String VideoEmbededAdress =
                        "<html>" +
                                "<body>" +
                                "<script type='text/javascript' src='http://www.youtube.com/iframe_api'></script><script type='text/javascript'>\n" +
        ...
        else if(compositionLayoutDetail.getType().equalsIgnoreCase("text_app"))
        {
            ...
            mZoneFourLayoutDigitalClock.setVisibility(View.GONE);
            mZoneFourLayoutTwitter.setVisibility(View.GONE);
            mZoneFourLayoutText.setVisibility(View.VISIBLE);
            mZoneFourLayoutURL.setVisibility(View.GONE);
            mZoneFourLayoutVideo.setVisibility(View.GONE);
            mZoneFourLayoutYoutubeVideo.setVisibility(View.GONE);
            mZoneFourLayoutSpreadSheet.setVisibility(View.GONE);
            ...
            TextView  txtMarquee = (TextView) findViewById(R.id.zone_four_text);
            LinearLayout linearLayout = findViewById(R.id.zone_four_text_layout);
            if(compositionLayoutDetail.getBackground_color() != null)
            {
                linearLayout.setBackgroundColor(Color.parseColor(compositionLayoutDetail.getBackground_color()));
            }
...
//            txtMarquee.setSpeed(100.0f);
        ...
        else if(compositionLayoutDetail.getType().equalsIgnoreCase("youtube"))
        {
            ...
            mZoneFourLayoutURL.setVisibility(View.GONE);
            mZoneFourLayoutVideo.setVisibility(View.GONE);
            mZoneFourLayoutYoutubeVideo.setVisibility(View.VISIBLE);
            mZoneFourLayoutSpreadSheet.setVisibility(View.GONE);
            mZoneFourLayoutGoogleSlide.setVisibility(View.GONE);
            mZoneFourLayoutRTSP.setVisibility(View.GONE);
            if(compositionLayoutDetail.getYoutube_video_ids() != null)
            {
                String[] separated = compositionLayoutDetail.getYoutube_video_ids().split(",");
                getYoutubeAPIZoneFourResponse(separated,300);
            }
        }
        ...
        else if(compositionLayoutDetail.getType().equalsIgnoreCase("spreadsheets_url"))
        {
            ...
            mZoneFourLayoutVideo.setVisibility(View.GONE);
            mZoneFourLayoutYoutubeVideo.setVisibility(View.GONE);
            mZoneFourLayoutSpreadSheet.setVisibility(View.VISIBLE);
            mZoneFourLayoutGoogleSlide.setVisibility(View.GONE);
            mZoneFourLayoutRTSP.setVisibility(View.GONE);

            if(compositionLayoutDetail.getApp_url() != null)
            {
                WebView webView = (WebView) findViewById(R.id.zone_four_spreadsheets_webview);
                webView.setWebViewClient(new WebViewClientImpl());
                webView.getSettings().setLoadsImagesAutomatically(true);
                webView.getSettings().setJavaScriptEnabled(true);
                webView.setScrollBarStyle(View.SCROLLBARS_INSIDE_OVERLAY);
        ...
        else if(compositionLayoutDetail.getType().equalsIgnoreCase("google_slides_url"))
        {
            ...
            mZoneFourLayoutYoutubeVideo.setVisibility(View.GONE);
            mZoneFourLayoutSpreadSheet.setVisibility(View.GONE);
            mZoneFourLayoutGoogleSlide.setVisibility(View.VISIBLE);
            mZoneFourLayoutRTSP.setVisibility(View.GONE);

            if(compositionLayoutDetail.getApp_url() != null)
            {
                WebView webView = (WebView) findViewById(R.id.zone_four_google_slides_webview);
                webView.setWebViewClient(new WebViewClientImpl());
                webView.getSettings().setLoadsImagesAutomatically(true);
                webView.getSettings().setJavaScriptEnabled(true);
                webView.setScrollBarStyle(View.SCROLLBARS_INSIDE_OVERLAY);
        ...
        else if(compositionLayoutDetail.getType().equalsIgnoreCase("rtsp"))
        {
            ...
            mZoneFourLayoutSpreadSheet.setVisibility(View.GONE);
            mZoneFourLayoutGoogleSlide.setVisibility(View.VISIBLE);
            mZoneFourLayoutRTSP.setVisibility(View.VISIBLE);

            if(compositionLayoutDetail.getApp_url() != null)
            {
                Log.d(TAG, "Playing rtsp url zone 4: " + compositionLayoutDetail.getApp_url());

                mSurfaceZoneFour = findViewById(R.id.zone_four_rtsp);
                WindowManager wm = this.getWindowManager();
                int width = wm.getDefaultDisplay().getWidth();
                int height = wm.getDefaultDisplay().getHeight();
                int iNewWidth = (int) (height * 3.0 / 4.0);
...
//                layoutParams.setMargins(iPos, 0, 0, 0);
                mSurfaceZoneFour.getHolder().setFixedSize(width/2, height/2);
                mSurfaceZoneFour.getHolder().setType(SurfaceHolder.SURFACE_TYPE_PUSH_BUFFERS);
                mSurfaceZoneFour.getHolder().setKeepScreenOn(true);
//                mSurfaceZoneFour.getHolder().addCallback(new SurceCallBack());
                mSurfaceZoneFour.setLayoutParams(layoutParams);
                holderZoneFour = mSurfaceZoneFour.getHolder();
                //holder.addCallback(this);
                ...
                libvlcZoneFour = new LibVLC(getApplicationContext(), options);
                holderZoneFour.setKeepScreenOn(true);

                // Create media player
                mMediaPlayerZoneFour = new MediaPlayer(libvlcZoneFour);
                mMediaPlayerZoneFour.setEventListener(mPlayerListenerZoneFour);

                // Set up video output
                final IVLCVout vout = (IVLCVout) mMediaPlayerZoneFour.getVLCVout();
                vout.setVideoView(mSurfaceZoneFour);
                //vout.setSubtitlesView(mSurfaceSubtitles);
                vout.addCallback(this);
                vout.attachViews();
                Media m = new Media(libvlcZoneFour, Uri.parse(compositionLayoutDetail.getApp_url()));
                mMediaPlayerZoneFour.setMedia(m);
                mMediaPlayerZoneFour.play();
            }
        }
    }
    ...
    private void getYoutubeAPIZoneOneResponse(String[] youtubeVideoID, int slide_duration) throws JSONException {
        ...
        {
            YoutubeZoneOneAdapter adapter = new YoutubeZoneOneAdapter(CompositionLayoutFourDBActivity.this,
                    youtubeVideoID);
    ...
    private void getYoutubeAPIZoneTwoResponse(String[] youtubeVideo, int slide_duration) throws JSONException  {
        ...
        {
            YoutubeZoneTwoAdapter adapter = new YoutubeZoneTwoAdapter(CompositionLayoutFourDBActivity.this,
                    youtubeVideo);
    ...
    private void getYoutubeAPIZoneThreeResponse(String[] youtubeVideo, int slide_duration) throws JSONException  {
        if(youtubeVideo != null)
        {
            YoutubeZoneThreeAdapter adapter = new YoutubeZoneThreeAdapter(CompositionLayoutFourDBActivity.this,
                    youtubeVideo);
    ...
    private void getYoutubeAPIZoneFourResponse(String[] youtubeVideo, int slide_duration) throws JSONException  {
        if(youtubeVideo != null)
        {
            YoutubeZoneFourAdapter adapter = new YoutubeZoneFourAdapter(CompositionLayoutFourDBActivity.this,
                    youtubeVideo);
            mVideoSliderViewZoneFour.setAutoCycleDirection(SliderView.LAYOUT_DIRECTION_LTR);
            mVideoSliderViewZoneFour.setScrollTimeInSec(slide_duration);
            mVideoSliderViewZoneFour.setAutoCycle(true);
            mVideoSliderViewZoneFour.startAutoCycle();
            mVideoSliderViewZoneFour.setSliderAdapter(adapter);
        }
    }
...
//            Log.d("TAG", "<< Response of twitterDetail "+twitterResponse.getMediaData().getSlideDuration());
                ...
                TwitterZoneOneAdapter adapter = new TwitterZoneOneAdapter(CompositionLayoutFourDBActivity.this,
...
//            Log.d("TAG", "<< Response of twitterDetail "+twitterResponse.getMediaData().getSlideDuration());
                // passing this array list inside our adapter class.
                TwitterZoneTwoAdapter adapter = new TwitterZoneTwoAdapter(CompositionLayoutFourDBActivity.this,
                        jsonTwitterListResponse);
                // below method is used to set auto cycle direction in left to
                // right direction you can change according to requirement.
...
//            Log.d("TAG", "<< Response of twitterDetail "+twitterResponse.getMediaData().getSlideDuration());
                // passing this array list inside our adapter class.
                TwitterZoneThreeAdapter adapter = new TwitterZoneThreeAdapter(CompositionLayoutFourDBActivity.this,
                        jsonTwitterListResponse);
                // below method is used to set auto cycle direction in left to
                // right direction you can change according to requirement.
    ...
    private void getTwitterAPILocalZoneFourResponse(String  twitterProfileData,
                                                     String  twitterFeedsList, int zone,
                                                     String slide_duration) throws JSONException  {
            ...
            if(jsonProfileDataResponse != null)
            {
                ...
                if(twitterArryaData != null)
                {
                    for(int i = 0; i < twitterArryaData.length(); i++) {
                        ...
                        if(respTwitterObj != null)
                        {
                            ImageView imgProfile = findViewById(R.id.twitter_profile_img_zone_four);
                            TextView tvName = findViewById(R.id.twitter_user_name_txt_zone_four);
                            TextView tvUserName = findViewById(R.id.twitter_user_txt_zone_four);
                            tvName.setText((respTwitterObj.getString("name") != null) ?
                                    respTwitterObj.getString("name") : "");
                            tvUserName.setText((respTwitterObj.getString("username") != null) ?
                                    respTwitterObj.getString("username") : "");
...
//            Log.d("TAG", "<< Response of twitterDetail "+twitterResponse.getMediaData().getSlideDuration());
                // passing this array list inside our adapter class.
                TwitterZoneFourAdapter adapter = new TwitterZoneFourAdapter(CompositionLayoutFourDBActivity.this,
                        jsonTwitterListResponse);
                // below method is used to set auto cycle direction in left to
                // right direction you can change according to requirement.
                sliderView_zone_four.setAutoCycleDirection(SliderView.LAYOUT_DIRECTION_LTR);

                // below method is use to set
                // scroll time in seconds.
                int duration = Integer.parseInt(slide_duration);
                sliderView_zone_four.setScrollTimeInSec(duration);

                // to set it scrollable automatically
                // we use below method.
                sliderView_zone_four.setAutoCycle(true);

                // to start autocycle below method is used.
                sliderView_zone_four.startAutoCycle();

                // below method is used to
                // setadapter to sliderview.
                sliderView_zone_four.setSliderAdapter(adapter);
    ...
    private void getWeatherDetailByCity(String weatherResponse, int zone) throws JSONException, ParseException {
        Log.d("TAG", "<< Response of layout 4 weather locationweatherResponse "+weatherResponse);
...
//              System.out.println("===== res <<<<<<<<<<<< weather response : "+mJsonObject);
                ...
                TextView tv_weather_feel_zone_four = findViewById(R.id.zone_four_txt_weather_feel);
                ImageView icon_weather_zone_four = findViewById(R.id.zone_four_weather_icon);
                TextView tv_weather_city_zone_four = findViewById(R.id.zone_four_txt_weather_city);
                TextView tv_weather_temp_zone_four = findViewById(R.id.zone_four_txt_weather_temp);

                ImageView weather_icon_one_zone_four = findViewById(R.id.zone_one_weather_icon_one);
                TextView tv_weather_feel_one_zone_four = findViewById(R.id.zone_four_txt_weather_feel_one);
                TextView tv_weather_date_one_zone_four = findViewById(R.id.zone_four_txt_weather_date_one);
                TextView tv_weather_temp_one_zone_four = findViewById(R.id.zone_four_txt_weather_temp_one);

                ImageView weather_icon_two_zone_four = findViewById(R.id.zone_one_weather_icon_two);
                TextView tv_weather_feel_two_zone_four = findViewById(R.id.zone_four_txt_weather_feel_two);
                TextView tv_weather_date_two_zone_four = findViewById(R.id.zone_four_txt_weather_date_two);
                TextView tv_weather_temp_two_zone_four = findViewById(R.id.zone_four_txt_weather_temp_two);

                ImageView weather_icon_three_zone_four = findViewById(R.id.zone_one_weather_icon_three);
                TextView tv_weather_feel_three_zone_four = findViewById(R.id.zone_four_txt_weather_feel_three);
                TextView tv_weather_date_three_zone_four = findViewById(R.id.zone_four_txt_weather_date_three);
                TextView tv_weather_temp_three_zone_four = findViewById(R.id.zone_four_txt_weather_temp_three);

                ImageView weather_icon_four_zone_four = findViewById(R.id.zone_one_weather_icon_four);
                TextView tv_weather_feel_four_zone_four = findViewById(R.id.zone_four_txt_weather_feel_four);
                TextView tv_weather_date_four_zone_four = findViewById(R.id.zone_four_txt_weather_date_four);
                TextView tv_weather_temp_four_zone_four = findViewById(R.id.zone_four_txt_weather_temp_four);
                ...
                if (zone == 1) {
                    ...
                    if(mJsonObject1.getString("main").equalsIgnoreCase("Clouds"))
                    {
                        Glide.with(getApplicationContext())
                                ...
                                .dontAnimate()
                                .diskCacheStrategy(DiskCacheStrategy.ALL)
                                .into(weather_icon_one_zone_four);
                    }
                    else if(mJsonObject1.getString("main").equalsIgnoreCase("Rain"))
                    {
                        Glide.with(getApplicationContext())
                    ...
                    if(mJsonObject2.getString("main").equalsIgnoreCase("Clouds"))
                    {
                        Glide.with(getApplicationContext())
                                ...
                                .dontAnimate()
                                .diskCacheStrategy(DiskCacheStrategy.ALL)
                                .into(weather_icon_two_zone_four);
                    }
                    else if(mJsonObject2.getString("main").equalsIgnoreCase("Rain"))
                    {
                        Glide.with(getApplicationContext())
                    ...
                    if(mJsonObject3.getString("main").equalsIgnoreCase("Clouds"))
                    {
                        Glide.with(getApplicationContext())
                                ...
                                .dontAnimate()
                                .diskCacheStrategy(DiskCacheStrategy.ALL)
                                .into(weather_icon_three_zone_four);
                    }
                    else if(mJsonObject3.getString("main").equalsIgnoreCase("Rain"))
                    {
                        Glide.with(getApplicationContext())
                    ...
                    if(mJsonObject4.getString("main").equalsIgnoreCase("Clouds"))
                    {
                        Glide.with(getApplicationContext())
                                ...
                                .dontAnimate()
                                .diskCacheStrategy(DiskCacheStrategy.ALL)
                                .into(weather_icon_four_zone_four);
                    }
                    else if(mJsonObject4.getString("main").equalsIgnoreCase("Rain"))
                    {
                        Glide.with(getApplicationContext())
                    ...
                    tv_weather_feel_zone_four.setText("feel like: " + Double.valueOf(dtime.format(feel)) + temp_type);
                    tv_weather_city_zone_four.setText(myCityJson.getString("name"));
                    tv_weather_temp_zone_four.setText(Double.valueOf(dtime.format(temp)) + temp_type);
                    ...
                    tv_weather_feel_one_zone_four.setText("feel like: " + Double.valueOf(dtime.format(feel1)) + temp_type);
                    tv_weather_date_one_zone_four.setText(weatherDateStrOne);
                    tv_weather_temp_one_zone_four.setText(Double.valueOf(dtime.format(temp1)) + temp_type);

                    tv_weather_feel_two_zone_four.setText("feel like: " + Double.valueOf(dtime.format(feel2)) + temp_type);
                    tv_weather_date_two_zone_four.setText(weatherDateStrTwo);
                    tv_weather_temp_two_zone_four.setText(Double.valueOf(dtime.format(temp2)) + temp_type);

                    tv_weather_feel_three_zone_four.setText("feel like: " + Double.valueOf(dtime.format(feel3)) + temp_type);
                    tv_weather_date_three_zone_four.setText(weatherDateStrThree);
                    tv_weather_temp_three_zone_four.setText(Double.valueOf(dtime.format(temp3)) + temp_type);

                    tv_weather_feel_four_zone_four.setText("feel like: " + Double.valueOf(dtime.format(feel4)) + temp_type);
                    tv_weather_date_four_zone_four.setText(weatherDateStrFour);
                    tv_weather_temp_four_zone_four.setText(Double.valueOf(dtime.format(temp4)) + temp_type);
                }
            }
        }
    }
            ...
            public void onChanged(List<CompositionLayoutDetail> compositionLayoutDetail) {
                ...
                for(int i = 0; i< compositionLayoutDetail.size(); i++)
                {
                    ...
                    else if(compositionLayoutDetail.get(i).getZone_type().equalsIgnoreCase("zone4"))
                    {
                        ...
                        if(layoutDetail3 != null)
                        {
                            compositionLayoutDetailsFour.add(layoutDetail3);
                            mZoneFourList.add(compositionLayoutDetail.get(i).getMedia_id());
                            mZoneFourDurationList.add(compositionLayoutDetail.get(i).getDuration());
                        }
                    }
                                ...
                                if (layoutDetailList.size() > 0) {
                                    for (int i = 0; i < layoutDetailList.size(); i++) {
                                        ...
                                        if (compositionLayoutDetail != null) {
                                            ...
                                            else if(compositionLayoutDetail.getZone_type().equalsIgnoreCase("zone4"))
                                            {
                                                CompositionLayoutDetail layoutDetail4 = compositionLayoutDetail;
                                                if(layoutDetail4 != null)
                                                {
                                                    compositionLayoutDetailsFour.add(layoutDetail4);
                                                    mZoneFourList.add(compositionLayoutDetail.getMedia_id());
                                                    mZoneFourDurationList.add(compositionLayoutDetail.getDuration());
                                                }
                                            }
                                        }
                                    }
...
//                                    updateCompositionLayoutDetail();
    ...
    private void deviceStatus(String status, String method) {
        Log.d(TAG, "<< device status is: "+status +" << device method is: "+method+" << device layout is 4");
    ...
    public void deleteCache(Context context) {
        try {
            ...
            deleteDir(dir);
            startActivity(new Intent(CompositionLayoutFourDBActivity.this, SplashActivity.class));
            finish();
    ...
    {
        Log.d(TAG, "<< push status in layout 4:  " + ApplicationPreferences.getInstance(getApplicationContext()).getNotificationReceive());
        Log.d(TAG, "<< push status in layout 4 COMPOSITION_ID:  " + getIntent().getStringExtra("COMPOSITION_ID"));
        Log.d(TAG, "<< push status in layout 4 ORIENTATION:  " + getIntent().getStringExtra("ORIENTATION"));
    ...
    public void releasePlayerZoneFour() {
        if (libvlcZoneFour == null)
            return;
        mMediaPlayerZoneFour.stop();
        final IVLCVout vout = (IVLCVout) mMediaPlayerZoneFour.getVLCVout();
        vout.removeCallback(this);
        vout.detachViews();
        holderZoneFour = null;
        libvlcZoneFour.release();
        libvlcZoneFour = null;
    }
...
//                Toast.makeText(context, "Download result error: " + result, Toast.LENGTH_LONG).show();
                ...
                ApplicationPreferences.getInstance(CompositionLayoutFourDBActivity.this).setIsDownload(true);
...
//                Toast.makeText(CompositionLayoutThreeDBActivity.this, "Video Download complete.", Toast.LENGTH_SHORT).show();
    ...
    public void newDownload(String url, String type) {
        final DownloadTask downloadTask = new DownloadTask(CompositionLayoutFourDBActivity.this);
    ...
    private void takePermission()
    {
        ...
        {
            /*ActivityCompat.requestPermissions(CompositionLayoutFourDBActivity.this, new String[] {
    ...
    public void onDestroy(){
        ...
        handlerZoneFour.removeCallbacks(runnableZoneFour);
        ...
        if(mMediaPlayerZoneFour != null)
        {
            releasePlayerZoneFour();
        }
    ...
    protected void onResume() {
        ...
        /*if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.R)
        {
            ...
            if(!Utils.isPermissionGranted(CompositionLayoutFourDBActivity.this))
            {
                new AlertDialog.Builder(CompositionLayoutFourDBActivity.this)
            ...
            {
//            Toast.makeText(CompositionLayoutFourDBActivity.this, "Permission already granted", Toast.LENGTH_LONG).show();
            }
        }*/
